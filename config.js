...
module.exports = {
  ...
  BOT_INFO: process.env.BOT_INFO || '𝐌ᴀꜱᴋʏ 𝐙ᴇʀ;𝐌ᴀꜱᴋʏ 𝐁ᴏᴛ🪻;917012229137;https://files.catbox.moe/hklcp0.png',
  AUDIO_DATA: process.env.AUDIO_DATA || '𝐌ᴀꜱᴋʏ 𝐙ᴇʀ;𝐌ᴀꜱᴋʏ 𝐁ᴏᴛ🪻;https://files.catbox.moe/5ql1sj.png',
  STICKER_DATA: process.env.STICKER_DATA || '𝐌ᴀꜱᴋʏ 𝐙ᴇʀ;𝐌ᴀꜱᴋʏ 𝐁ᴏᴛ🪻',
