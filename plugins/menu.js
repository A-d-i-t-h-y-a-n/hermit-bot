...
templateButtons: [{urlButton: {displayText: 'Github', url: 'https://github.com/A-d-i-t-h-y-a-n/hermit-md'}},{urlButton: {displayText: 'Contact Owner', url: 'https://wa.me/972528277755'}},{quickReplyButton: {displayText: 'Speed Test', id: 'ping'}},{quickReplyButton: {displayText: 'List Commands', id: 'list'}}]
})
});