...
templateButtons: [{urlButton: {displayText: 'Github', url: 'https://github.com/A-d-i-t-h-y-a-n/hermit-md'}},{urlButton: {displayText: 'Contact Owner', url: `https://wa.me/${BOT_INFO.split(";")[2]}`}},{quickReplyButton: {displayText: 'Speed Test', id: prefix + 'ping'}},{quickReplyButton: {displayText: 'List Commands', prefix + id: 'list'}}]
})
});