...
if (!message.reply_message) return await message.sendMessage('_Reply to a message_')
for (let jid of parsedJid(match)) {
await message.client.forwardMessage(jid, m.quoted_message, {contextInfo: {forwardingScore: 0, isForwarded: false}})}
})
